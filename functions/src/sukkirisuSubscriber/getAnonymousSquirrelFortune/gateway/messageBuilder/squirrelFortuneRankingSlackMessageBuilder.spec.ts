...
import { SquirrelFortuneRankingSlackMessageBuilder }
  from "./squirrelFortuneRankingSlackMessageBuilder";
should();
...
describe("AnonymousSquirrelFortuneRankingSlackMessageBuilder", () => {
  it("should render correct slack message given SquirrelFortuneRanking", () => {
    ...
    const slackMessageBuilder = new SquirrelFortuneRankingSlackMessageBuilder();
    const message = slackMessageBuilder.build(squirrelFortuneRanking);
